...
<body>
    <center>
        ...
        <b style="font-size: 14px">Yeay, pesanan sudah dikonfirmasi !.</b>
        <p  style="font-size: 13px">Halo {{ $nama_lengkap }},</p>
        <p style="font-size: 13px">Pesananmu dengan nomor <b>{{ $no_pesanan }}</b><br>
        sudah kami konfirmasi. Segera lakukan pembayaran<br>
        agar pesananmu segera kami proses.</p>
