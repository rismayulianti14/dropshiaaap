    ...
    <section class="content">
        <div class="container-fluid">
            <div class="callout callout-default">
                ...
                {{ $detail_agen->alamat_detail }}, {{ $detail_agen->subdistrict_name }}, {{ $detail_agen->city_name }}, {{ $detail_agen->province_name }}, {{ $detail_agen->kode_pos }}<br>
            ...
            <div class="row">
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <form method="post" action="{{ route('agen.order.update-cart', $row->id_agen) }}">
                                        @csrf
                                        <tr>
                                            <td>
                                                <a href="{{ route('agen.order.destroy-produk', $row->id) }}" class="btn btn-sm btn-danger hapus">
                                            ...
                                            <td>{{ isset($row->produk->nama_produk) ? $row->produk->nama_produk : 'Data produk tidak tersedia'  }}</td>
                ...
                <div class="col-md-4">
                    <div class="card card-orange">
                        ...
                        <form method="post" action="{{ route('agen.order.checkout-pjawa') }}">
                        @csrf
                        <div class="card-body">
            ...
            @else
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <div class="quantity buttons_added">
                                                    <button class="minus" type="button" onclick="kurangQty('{{ $row->id }}')"> - </button>
                                                    <input type="number" name="kuantitas" id="qty_{{ $row->id }}" maxlength="12" value="{{ $row->qty }}" title="Quantity:" class="input-text qty text" size="5" min="1" disabled>
                                                    <button class="plus" type="button" onclick="tambahQty('{{ $row->id }}')"> + </button>
                                                </div>
                                            </td>
                                            <td>
                                                Rp.<span id="subtotal_{{ $row->id }}">{{ number_format( $row->subtotal, 0 ,'' , '.' ) }}</span>
                ...
                <div class="col-md-4">
                    <div class="card card-orange">
                        ...
                        <form method="post" action="{{ route('agen.order.checkout-ljawa') }}">
                        @csrf
                        <div class="card-body">
                            <input type="hidden" name="no_pesanan" value="{{ $no_pesanan }}">
                            <input type="hidden" name="id_agen" value="{{ Session::get('id') }}">
