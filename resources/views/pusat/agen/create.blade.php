            ...
            <div class="row">
                <div class="col-md-12"> 
                    <div class="card card-orange">
                        ...
                        <form id="form" method="POST" action="{{ route('pusat.agen.store') }}" enctype="multipart/form-data">
                        @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="kode_id">ID Agen</label>
                                    <input type="text" class="form-control" value="{{ $kode_id }}" disabled>
                                    <input type="hidden" id="id_agen" name="kode_id" value="{{ $kode_id }}">
                                </div>

                                <div class="form-group">
                                    <label for="nama_lengkap">Nama lengkap</label>
                                    <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" id="nama_lengkap" name="nama_lengkap" placeholder="Masukkkan nama lengkap agen" value="{{ old('nama_lengkap') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Masukkkan nama pengguna agen" value="{{ old('username') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Masukkkan email agen" value="{{ old('email') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('telepon') is-invalid @enderror" id="telepon" name="telepon" placeholder="Masukkkan nomor telepon agen" value="{{ old('telepon') }}">
                ...
                <div class="col-md-12"> 
                    <div class="card card-orange">
                        <div class="card-header">
                            <h3 class="card-title text-white">I). Data lengkap</h3>
                        </div>
                            <div class="card-body">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kode_pos') is-invalid @enderror" id="kode_pos" name="kode_pos" placeholder="Masukkan kode pos agen">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('alamat_detail') is-invalid @enderror" id="alamat_detail" name="alamat_detail" placeholder="Masukkan alamat detail agen">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror" id="pekerjaan" name="pekerjaan" placeholder="Masukkan pekerjaan agen">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" placeholder="Masukkan tempat lahir agen">
                                        ...
                                        <div class="col-7">
                                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" name="tanggal_lahir" placeholder="Masukkan tanggal lahir agen">
