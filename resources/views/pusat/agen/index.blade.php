                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('pusat.agen.export-excel') }}" type="button" class="btn btn-block btn-default btn-md" style="margin-bottom: 5px">
                                        <i class="fas fa-table"> </i>
                                        Export Excel
                                    </a>
                                </div>
                                <div class="col-md-2">
                                    <a href="{{ route('pusat.agen.export-pdf') }}" type="button" class="btn btn-block btn-default btn-md" style="margin-bottom: 5px">
                                        <i class="fas fa-file-pdf"> </i>
                                        Export PDF
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <a href="{{ route('pusat.agen.create') }}" type="button" class="btn btn-block bg-orange btn-md" style="margin-bottom: 5px">
                            ...
                            <table id="table" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%" align="center">Nama lengkap</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle">
                                            <a href="{{ asset('uploads/agen/'. $row->image) }}" data-lightbox="photos">  
                                                <img src="{{ asset('uploads/agen/'. $row->image) }}" alt="" style="height: 60px; width: 60px">
                                            </a>
                                        </td>
                                        ...
                                        <td style="vertical-align: middle">
                                            <a href="{{ route('pusat.agen.rekap-penjualan', $row->id) }}" type="button" class="btn btn-block btn-outline-success btn-sm" style="margin-bottom: 5px;">
                                               Rekap transaksi
                                            </a>
                                        </td>
                                        <td align="center" style="vertical-align: middle" width="20%">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <a href="" id="detailAgen" data-toggle="modal" data-target="#modalDetail" data-id="{{ $row->id }}" class="btn btn-block btn-outline-info btn-sm" style="margin-bottom: 5px;">
                                                        <i class="fa fa-info"></i>
                                                    </a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="{{ route('pusat.agen.edit', $row->id) }}" type="button" class="btn btn-block btn-outline-warning btn-sm" style="margin-bottom: 5px;">
                                                        <i class="fa fa-pen"></i>
                                                    </a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="{{ route('pusat.agen.hapus', $row->id) }}" type="button" class="btn btn-block btn-outline-danger btn-sm hapus">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table width="100%" border="0">
                    <tr>
                        <td colspan="4" align="center" style="padding-top: 10px; background-color: #f89520; color: #fff"><h3 id="kode_id"></h3></td>
                    </tr>
                    <tr>
                        <td width="25%" style="padding-left: 10px; padding-top: 10px">Nama</td>
                        <td width="1%" style="padding-top: 10px">: </td>
                        <td width="34%" id="nama_lengkap" style="padding-top: 10px"></td>
...
$(document).ready(function () {
    ...
    $('body').on('click', '#detailAgen', function (event) {
        ...
        $.get('/pusat/agen/detail-agen/' + id + '/get', function (data) {
            console.log(data);
