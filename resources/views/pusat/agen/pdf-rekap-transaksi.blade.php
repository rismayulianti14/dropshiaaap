...
<body>
    ...
    <table border="0" width="100%" style="border-collapse: collapse">
        <tr>
            ...
            <td style="font-size: 15px"><b>{{ $agen->kode_id }}</b></td>
        </tr>
        <tr>
            <td style="font-size: 15px">Nama</td>
            <td style="font-size: 15px">:</td>
            <td style="font-size: 15px">{{ $agen->nama_lengkap }} <span style="color: #777; font-size: 13px">( Agen )</span></td>
        </tr>
        <tr>
            <td style="font-size: 15px">Alamat</td>
            <td style="font-size: 15px">:</td>
            <td style="font-size: 15px">
                {{ $agen->alamat_detail }}, {{ $agen->subdistrict_name }}, {{ $agen->city_name }},<br>
                {{ $agen->province_name }}, Indonesia, {{ $agen->kode_pos }}
            </td>
        </tr>
    </table>
                        ...
                        <tr>
                            <td style="font-size: 14px; padding: 3px;">
                                @foreach($detail_transaksi as $det)
                                    ...
                                    - {{ $det->nama_produk }} <span style="font-size: 13px; color: #777">( x {{ $det->qty }} )</span><br>
                                    @endif
                                @endforeach
                            </td>
