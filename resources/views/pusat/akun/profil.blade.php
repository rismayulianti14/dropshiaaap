                ...
                <div class="col-md-4">
                    <div class="card card-orange card-outline">
                        <div class="card-body box-profile">
                            <form action="{{ route('pusat.profil.ubah-foto', Session::get('id')) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="text-center" style="margin-bottom: 20px">
                                    <img class="profile-user-img img-fluid img-circle"
                                        src="{{ asset('uploads/petugas/'. Session::get('image')) }}"
                ...
                <div class="col-md-8">
                    <div class="card card-orange">
                        <div class="card-header">
                            <h3 class="card-title text-white" style="vertical-align: middle">Tentang saya</h3>

                            <div id="btn_edit"> 
                                <button class="btn btn-md btn-default float-right" id="editPusat" data-id="{{ Session::get('id') }}">
                                    Edit
                                </button>
                            </div>
                        </div>
                        <form  method="post" action="{{ route('pusat.profil.ubah-profil') }}" id="update">
                        @csrf
                        <div class="card-body">
                            ...
                            <strong><i class="fas fa-id-card mr-1"></i> Posisi</strong>

                            <p class="text-muted" id="posisi">
                                {{ Session::get('posisi') }}
                            </p>
