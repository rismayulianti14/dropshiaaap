			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('pusat.order.belum-bayar') }}" style="color: #f89520">Pesanan belum dibayar</a></li>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
										@foreach($detail_transaksi as $key=>$det)
											...
											<tr>
												<td>#</td>
												<td>{{ isset($det->produk->nama_produk) ? $det->produk->nama_produk : ''  }}</td>
                                ...
                                <div class="table-responsive">
                                    <table class="table" border="0">
                                        <tr>
                                            ...
                                            <td><span>Rp.{{ number_format( $head_transaksi->total_pembelian, 0 ,'' , '.' ) }}</span></td>
                                        </tr>
                                        <tr>
                                            <th>Ongkos kirim</th>
                                            <td><span>Rp.{{ number_format( $head_transaksi->ongkir, 0 ,'' , '.' ) }}</span></td>
                                        </tr>
                                        <tr>
                                            <th>Total</th>
                                            <td><b>Rp.{{ number_format( $head_transaksi->grand_total, 0 ,'' , '.' ) }}</b></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
