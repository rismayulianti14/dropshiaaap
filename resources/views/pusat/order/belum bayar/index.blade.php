                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('pusat.order.belum-bayar-pdf') }}" type="button" class="btn btn-block btn-default btn-md" style="margin-bottom: 5px">
                        ...
                        <div class="card-body">
                            <table id="table" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class='clickable-row' data-href="{{ route('pusat.order.belum-bayar.detail', $row->no_pesanan) }}">
