...
<body>
    ...
    <center>
    <hr>
    <h3>Laporan pesanan belum dibayar konsumen</h3>
    </center>
                ...
                <td>
                    <table border="0" width="100%" style="border-collapse: collapse; padding: 0 10px 0 10px">
                        <tr>
                            ...
                            <td align="right">
                                @if($row->id_reseller != null)
                                    <b><span class="float-right" style="color: #000">{{ $row->kurir }}</span></b>
                                @else
                    ...
                    <table border="1" width="100%" style="border-collapse: collapse; padding: 0 10px 10px 10px">
                        <tr>
                            <td width="45%" style="color: #777; font-size: 14px; padding: 3px">Produk</td>
