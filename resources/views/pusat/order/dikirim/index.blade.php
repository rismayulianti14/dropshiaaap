			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Pesanan sedang dikirim</li>
					</ol>
				</div>
			</div>
		</div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('pusat.order.dikirim-pdf') }}" type="button" class="btn btn-block btn-default btn-md" style="margin-bottom: 5px">
                        ...
                        <table id="table" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class='clickable-row' data-href="{{ route('pusat.order.dikirim.detail', $row->no_pesanan) }}">
                                            ...
                                            <table class="table table-bordered">
                                                <tr  class='clickable-row' data-href="{{ route('pusat.order.dikirim.detail', $row->no_pesanan) }}">
                                                    ...
                                                    <td width="16%" style="vertical-align: middle; text-align: center" rowspan="{{ $detail_transaksi->count('id') }}">
                                                        <a href="{{ route('pusat.order.tracking', $row->no_pesanan) }}" type="submit" id="tracking" class="btn btn-block bg-orange btn-sm">
