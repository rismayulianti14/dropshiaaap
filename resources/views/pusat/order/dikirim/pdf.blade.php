...
<body>
    ...
    <center>
    <hr>
    <h3>Laporan pesanan sedang dikirim</h3>
    </center>
                        ...
                        <tr>
                            <td style="font-size: 14px; padding: 3px;">
                                @foreach($detail_transaksi as $det)
                                    ...
                                    - {{ isset($det->produk->nama_produk) ? $det->produk->nama_produk : 'Data produk tidak tersedia'  }} <span style="font-size: 13px; color: #777">( x {{ $det->qty }} )</span><br>
                                    @endif
                                @endforeach
                            </td>
