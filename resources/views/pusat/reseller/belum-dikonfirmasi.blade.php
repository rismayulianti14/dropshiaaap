...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Reseller belum dikonfirmasi</h1>
				</div>
				<div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('pusat.dashboard') }}" style="color: #f89520">Beranda</a></li>
                        ...
                        <li class="breadcrumb-item active">Reseller belum dikonfirmasi</li>
					</ol>
				</div>
			</div>
		</div>
                            ...
                            <table id="table" class="table table-bordered table-hover">
                                ...
                                @foreach($reseller as $key=>$row)
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle">
                                            <a href="{{ route('pusat.reseller.konfirmasi', $row->id) }}" type="button" class="btn btn-block btn-outline-danger btn-sm" style="margin-bottom: 5px;">
                                                <i class="fas fa-user"></i> Konfirmasi akun
                                            </a>
                                        </td>
                                        <td align="center" style="vertical-align: middle">
                                            <div class="row">
