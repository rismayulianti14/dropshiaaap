...
<div class="content-wrapper">
	...
	<div class="content">
		<div class="container">
            ...
            <div id="global-alert" class="alert alert-success alert-dismissible" style="margin: 15px 0 15px 0; opacity: 70%;">
                ...
                <div class="col-md-4">
                    <div class="card card-orange card-outline">
                        <div class="card-body box-profile">
                            <form action="{{ route('reseller.profil.ubah-foto', Session::get('id')) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="text-center" style="margin-bottom: 20px">
                                    <img class="profile-user-img img-fluid img-circle"
                                        src="{{ asset('uploads/reseller/'. Session::get('image')) }}"
                ...
                <div class="col-md-8">
                    <div class="card card-orange">
                        <div class="card-header">
                            ...
                            <div id="btn_edit"> 
                                <button class="btn btn-md btn-default float-right" id="editReseller" data-id="{{ Session::get('id') }}">
                                    Edit
                                </button>
                            </div>
                        </div>
                        <form  method="post" action="{{ route('reseller.profil.ubah-profil') }}" id="update">
                        @csrf
                        <div class="card-body">
                            <input type="hidden" name="id" value="{{ Session::get('id') }}">

                            <strong><i class="fas fa-user mr-1"></i> ID</strong>
                            <p class="text-muted" id="id">
                                {{ Session::get('kode_id') }}
                            </p>
                            <hr>
