	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('../style-login/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="POST" action="{{ route('reseller.login.store') }}">
				@csrf
					...
					<div class="text-right p-t-8 p-b-31">
						<a href="{{ route('reseller.lupa-sandi') }}">
							Lupa kata sandi ?
						</a>
					</div>
				...
				<div class="text-center p-t-8 p-b-31" style="margin-top: 20px">
