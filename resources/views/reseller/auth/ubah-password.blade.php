	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('/style-login/images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="POST" action="{{ route('reseller.lupa-sandi.post-ubah-password', ['token'=>$token, 'id'=>$user_id]) }}">
				@csrf
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Email tidak boleh kosong">
						...
						<input class="input100" type="text" name="password" placeholder="Masukkan kata sandi">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

                    <div class="wrap-input100 validate-input m-b-23" data-validate = "Email tidak boleh kosong">
						<span class="label-input100">Konfirmasi kata sandi</span>
						<input class="input100" type="text" name="confirmpassword" placeholder="Masukkan kata sandi sekali lagi">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
