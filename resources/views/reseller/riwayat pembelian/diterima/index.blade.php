                    ...
                    <div class="card card-orange card-outline card-tabs">
                        <div class="card-header p-0 pt-1 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-orange" id="custom-tabs-three-profile-tab" href="{{ route('reseller.riwayat.belum-bayar') }}" aria-selected="true">
                                        Belum dibayar
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-orange" id="custom-tabs-three-settings-tab" href="{{ route('reseller.riwayat.dikirim') }}">
                                        Dikirim
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active text-orange" id="custom-tabs-three-settings-tab" href="{{ route('reseller.riwayat.diterima') }}">
                                        Selesai
